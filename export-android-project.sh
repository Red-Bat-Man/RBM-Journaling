...
cat > $EXPORT_DIR/BUILD_INSTRUCTIONS.md << 'EOF'
...
zip -r rbm-journal-android-export.zip $EXPORT_DIR

echo "Export completed! Download the rbm-journal-android-export.zip file to build the APK on your local machine."
echo "Follow the instructions in BUILD_INSTRUCTIONS.md for detailed build steps."